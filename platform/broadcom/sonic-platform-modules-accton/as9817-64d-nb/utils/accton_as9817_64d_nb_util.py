...
"""
usage: accton_as9817_64d_nb_util.py [-h] [-d] [-f] {install,clean,threshold} ...

AS9817-64D-NB Platform Utility
...
def main():
    ...
    util_parser = argparse.ArgumentParser(description="AS9817-64D-NB Platform Utility")
